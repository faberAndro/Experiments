...
NOTE: This exercise is in Python 3 -- 
if you wish to change to a language of
...
a text
 field where the manager will enter break info. 
...
The data given shows a shift started at 10AM and ended at 11PM. However, 
the break_notes "15-18" indicates that the staff member took a 3 hour break in the middle of the day (when they would not be paid). 
...
such as:
the total sales during this hour, 
the cost of labour for this hour, 
...
defined. 
This will be used for our tests, so be sure to output right answers
(it is not that hard to compute the result by hand, and compare it to the
output of your program) in the right format. 
If you need to create other
